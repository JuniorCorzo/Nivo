...
/**
 * Enriched read model representing a parking lot with aggregated slot distribution
 * and owner information.
 *
 * <p>This is a <strong>query-side model</strong> (CQRS read model) optimized for the
 * parking lot list endpoint. Unlike the full {@link ParkingLots} aggregate, this model
 * includes pre-computed slot counts and the owner's name, avoiding N+1 queries.
 *
 * <p><strong>Layer:</strong> Domain (Read Model)
 *
 ...
 * @param slotDistribution  Breakdown of slots by type (e.g., CAR: 10, MOTORCYCLE: 5)
