...
import dev.angelcorzo.neoparking.jpa.notificationpreferences.mapper.NotificationPreferencesMapper;
...
public class NotificationPreferencesRepositoryAdapter
   ...
   * the primary contact identifier in the NeoParking domain regardless of the delivery channel
