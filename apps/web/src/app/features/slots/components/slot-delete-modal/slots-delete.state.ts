...
export const getDeleteModalCopy = (
  ...
  if (scope === "batch") {
    return "Hay plazas seleccionadas. Debés confirmar para continuar.";
  }
...
export const requiresDeleteConfirm = (slot: SlotSummary | null): boolean => {
  if (!slot) {
    return false;
  }
