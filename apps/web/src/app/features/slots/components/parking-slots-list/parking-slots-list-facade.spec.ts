import { getDeleteModalCopy, getHistoryCopy, getStatusModalCopy, getStatusTransitionOptions, requiresDeleteConfirm, VALID_STATUS_TRANSITIONS } from './parking-slots-list.facade';
...
describe('ParkingSlotsListFacade pure functions', () => {
  ...
  describe('getStatusTransitionOptions', () => {
    ...
    it('should return empty array for unknown status', () => {
      const result = getStatusTransitionOptions('UNKNOWN' as any);
  ...
  describe('VALID_STATUS_TRANSITIONS', () => {
    it('should define transitions for all statuses', () => {
      const statuses: string[] = ['AVAILABLE', 'OCCUPIED', 'MAINTENANCE', 'RESERVED'];
