...
**Change**: `anc-22-parking-slots-management-ui`
**Version**: N/A
**Mode**: Strict TDD
**Date**: 2026-05-13
...
**Linter**: ➖ Not available / not run for changed files.
**Type Checker**: ⚠️ App typecheck passes; spec typecheck fails with repo config `TS6059` design-system/rootDir issue.
